...
echo "<td style='display: none'>"; echo $fila['password1'];echo "<td>";
  ...
  echo "<td><a href='php/Eliminar.php?USUARIO=".$fila['USUARIO']."'><button type='button'>Eliminar</button></a></td>";

  
  echo "<td><a href='index5.php?USUARIO=".$fila['USUARIO']."'><button type='button'>Editar</button></a></td>";
